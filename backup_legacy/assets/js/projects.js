const PROJECTS = [
  ...
  },
  {
    ...
    body: [
      "React Native (Expo) mobile app with Node.js/Express.js API.",
      "MySQL for persistence; deployed services on AWS.",
      "Gamified goals and educational content to encourage sustainable actions."
    ],
    links: [
